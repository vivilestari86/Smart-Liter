...
<div class="journal-form-page">
    <div class="journal-form-header">
        <h1>Edit Jurnal</h1>
        <p>Perbarui detail jurnal yang akan ditampilkan di halaman user.</p>
    </div>

    <form class="journal-form-card" action="{{ route('admin.jurnal.update', $journal) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
