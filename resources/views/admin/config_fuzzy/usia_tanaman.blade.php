...
@section('title','Konfigurasi Fuzzy - Usia Tanaman')
...
<div class="sl-page">
  <div class="sl-top">
    <div>
      ...
      <p class="sl-subtitle">Form konfigurasi fuzzy untuk Usia Tanaman.</p>
    </div>
  ...
  <div class="sl-panel">
    ...
    <div class="sl-card">
      <div class="sl-card-head">
        <h4>Parameter Titik Usia Tanaman</h4>
      </div>

      {{-- Grid: label + 8 input (sesuai gambar) --}}
      <div class="sl-grid-params">
        {{-- DINGIN --}}
        <div class="sl-tag dingin">Rendah</div>
        ...
        {{-- NORMAL --}}
        <div class="sl-tag normal">Sedang</div>
        ...
        {{-- PANAS --}}
        <div class="sl-tag panas">Tinggi</div>
      ...
      <div class="sl-bottom">
        ...
        <div class="sl-chart-wrap">
          ...
          <div style="background:#fff;border:1px solid #eef2f7;border-radius:12px;height:320px;display:flex;align-items:center;justify-content:center;">
            <span style="color:#6b7280;font-weight:700;">(Area Grafik Usia Tanaman)</span>
          </div>
        </div>
        ...
        <div class="sl-suhu">
          ...
          <div class="sl-result">
            <div class="name">Muda</div>
            <div class="val">0</div>

            <div class="name">Dewasa</div>
            <div class="val">1</div>

            <div class="name">Tua</div>
